...
class MultiLabelLinearClassifier(nn.Module):
    ...
    - no hidden layer
    - BCEWithLogitsLoss
    - prediction method returning probabilities and binary predictions
    """
    ...
    def create_classifier(
        ...
        self.model = nn.Linear(n_dim, num_classes)
    ...
    def extract_features(self, x: torch.Tensor) -> torch.Tensor:
        """
        For a linear classifier, there is no hidden representation.
